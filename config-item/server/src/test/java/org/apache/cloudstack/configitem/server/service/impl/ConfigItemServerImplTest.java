 ...
 * under the License.
 */
package org.apache.cloudstack.configitem.server.service.impl;
...
public class ConfigItemServerImplTest {
    ...
    @Mock
    ConfigItemVersionManager versionManager = null;
    ...
    public void test_write_string() throws Exception {
        server.register(new WriteStringConfigItem("string", "content"));
    ...
    public void test_applied_latest() throws Exception {
        ...
        server.register(new WriteStringConfigItem("name1", "content1"));
        server.handleRequest(req);
