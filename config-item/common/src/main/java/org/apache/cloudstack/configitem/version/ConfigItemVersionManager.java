 ...
 * under the License.
 */
package org.apache.cloudstack.configitem.version;

import org.apache.cloudstack.configitem.model.Client;
import org.apache.cloudstack.configitem.model.ItemVersion;

public interface ConfigItemVersionManager {

    void setApplied(Client client, String itemName, ItemVersion version);
