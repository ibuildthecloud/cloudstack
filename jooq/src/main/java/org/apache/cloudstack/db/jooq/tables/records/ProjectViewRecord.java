...
public class ProjectViewRecord extends org.jooq.impl.TableRecordImpl<org.apache.cloudstack.db.jooq.tables.records.ProjectViewRecord> {

	private static final long serialVersionUID = 719792731;
	...
	/**
	 * Setter for <code>cloud.project_view.name</code>. project name
	 */
	...
	/**
	 * Getter for <code>cloud.project_view.name</code>. project name
	 */
	...
	/**
	 * Setter for <code>cloud.project_view.display_text</code>. project name
	 */
	...
	/**
	 * Getter for <code>cloud.project_view.display_text</code>. project name
	 */
	...
	/**
	 * Setter for <code>cloud.project_view.state</code>. state of the project (Active/Inactive/Suspended)
	 */
	...
	/**
	 * Getter for <code>cloud.project_view.state</code>. state of the project (Active/Inactive/Suspended)
	 */
	...
	/**
	 * Setter for <code>cloud.project_view.removed</code>. date removed
	 */
	...
	/**
	 * Getter for <code>cloud.project_view.removed</code>. date removed
	 */
	...
	/**
	 * Setter for <code>cloud.project_view.created</code>. date created
	 */
	...
	/**
	 * Getter for <code>cloud.project_view.created</code>. date created
	 */
	...
	/**
	 * Setter for <code>cloud.project_view.owner</code>. an account name set by the creator of the account, defaults to username for single accounts
	 */
	...
	/**
	 * Getter for <code>cloud.project_view.owner</code>. an account name set by the creator of the account, defaults to username for single accounts
	 */
	...
	/**
	 * Setter for <code>cloud.project_view.account_id</code>. account id
	 */
	...
	/**
	 * Getter for <code>cloud.project_view.account_id</code>. account id
	 */
	...
	/**
	 * Setter for <code>cloud.project_view.tag_id</code>. id
	 */
	...
	/**
	 * Getter for <code>cloud.project_view.tag_id</code>. id
	 */
	...
	/**
	 * Setter for <code>cloud.project_view.tag_domain_id</code>. foreign key to domain id
	 */
	...
	/**
	 * Getter for <code>cloud.project_view.tag_domain_id</code>. foreign key to domain id
	 */
	...
	/**
	 * Setter for <code>cloud.project_view.tag_account_id</code>. owner of this network
	 */
	...
	/**
	 * Getter for <code>cloud.project_view.tag_account_id</code>. owner of this network
	 */
	...
	public ProjectViewRecord() {
		super(org.apache.cloudstack.db.jooq.tables.ProjectView.PROJECT_VIEW);
	}
