...
public class UserViewRecord extends org.jooq.impl.TableRecordImpl<org.apache.cloudstack.db.jooq.tables.records.UserViewRecord> {

	private static final long serialVersionUID = 457181496;
	...
	/**
	 * Setter for <code>cloud.user_view.created</code>. date created
	 */
	...
	/**
	 * Getter for <code>cloud.user_view.created</code>. date created
	 */
	...
	/**
	 * Setter for <code>cloud.user_view.removed</code>. date removed
	 */
	...
	/**
	 * Getter for <code>cloud.user_view.removed</code>. date removed
	 */
	...
	/**
	 * Setter for <code>cloud.user_view.is_registered</code>. 1: yes, 0: no
	 */
	...
	/**
	 * Getter for <code>cloud.user_view.is_registered</code>. 1: yes, 0: no
	 */
	...
	/**
	 * Setter for <code>cloud.user_view.default</code>. 1 if user is default
	 */
	...
	/**
	 * Getter for <code>cloud.user_view.default</code>. 1 if user is default
	 */
	...
	/**
	 * Setter for <code>cloud.user_view.account_name</code>. an account name set by the creator of the account, defaults to username for single accounts
	 */
	...
	/**
	 * Getter for <code>cloud.user_view.account_name</code>. an account name set by the creator of the account, defaults to username for single accounts
	 */
	...
	/**
	 * Setter for <code>cloud.user_view.job_status</code>. general job execution status
	 */
	...
	/**
	 * Getter for <code>cloud.user_view.job_status</code>. general job execution status
	 */
	...
	public UserViewRecord() {
		super(org.apache.cloudstack.db.jooq.tables.UserView.USER_VIEW);
	}
