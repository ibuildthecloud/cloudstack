...
public class DcStorageNetworkIpRange extends org.jooq.impl.TableImpl<org.apache.cloudstack.db.jooq.generated.tables.records.DcStorageNetworkIpRangeRecord> {
	...
	private static final long serialVersionUID = -988458253;
	 ...
	 */
	public final org.jooq.TableField<org.apache.cloudstack.db.jooq.generated.tables.records.DcStorageNetworkIpRangeRecord, java.lang.String> START_IP = createField("start_ip", org.jooq.impl.SQLDataType.CHAR.length(40).nullable(false), this);

	/**
	 * The column <code>cloud.dc_storage_network_ip_range.end_ip</code>. end ip address
	 */
	public final org.jooq.TableField<org.apache.cloudstack.db.jooq.generated.tables.records.DcStorageNetworkIpRangeRecord, java.lang.String> END_IP = createField("end_ip", org.jooq.impl.SQLDataType.CHAR.length(40).nullable(false), this);
	...
	public java.util.List<org.jooq.UniqueKey<org.apache.cloudstack.db.jooq.generated.tables.records.DcStorageNetworkIpRangeRecord>> getKeys() {
		return java.util.Arrays.<org.jooq.UniqueKey<org.apache.cloudstack.db.jooq.generated.tables.records.DcStorageNetworkIpRangeRecord>>asList(org.apache.cloudstack.db.jooq.generated.Keys.KEY_DC_STORAGE_NETWORK_IP_RANGE_PRIMARY, org.apache.cloudstack.db.jooq.generated.Keys.KEY_DC_STORAGE_NETWORK_IP_RANGE_ID, org.apache.cloudstack.db.jooq.generated.Keys.KEY_DC_STORAGE_NETWORK_IP_RANGE_UC_STORAGE_IP_RANGE__UUID);
	}
