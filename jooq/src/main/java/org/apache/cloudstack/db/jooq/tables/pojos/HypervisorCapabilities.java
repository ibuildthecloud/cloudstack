...
public class HypervisorCapabilities implements java.io.Serializable {
	...
	private static final long serialVersionUID = 1554483756;
	...
	private java.lang.Byte    vmSnapshotEnabled;
	...
	public HypervisorCapabilities(
		...
		java.lang.Byte    vmSnapshotEnabled
	) {
		this.id = id;
		this.uuid = uuid;
	...
	public void setVmSnapshotEnabled(java.lang.Byte vmSnapshotEnabled) {
		this.vmSnapshotEnabled = vmSnapshotEnabled;
	}
}
