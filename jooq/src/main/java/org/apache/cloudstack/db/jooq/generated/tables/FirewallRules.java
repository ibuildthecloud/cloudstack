...
public class FirewallRules extends org.jooq.impl.TableImpl<org.apache.cloudstack.db.jooq.generated.tables.records.FirewallRulesRecord> {
	...
	private static final long serialVersionUID = 417901027;
	 ...
	 */
	public final org.jooq.TableField<org.apache.cloudstack.db.jooq.generated.tables.records.FirewallRulesRecord, java.lang.String> STATE = createField("state", org.jooq.impl.SQLDataType.CHAR.length(32).nullable(false), this);

	/**
	 * The column <code>cloud.firewall_rules.protocol</code>. protocol to open these ports for
	 */
	public final org.jooq.TableField<org.apache.cloudstack.db.jooq.generated.tables.records.FirewallRulesRecord, java.lang.String> PROTOCOL = createField("protocol", org.jooq.impl.SQLDataType.CHAR.length(16).nullable(false).defaulted(true), this);

	/**
	 * The column <code>cloud.firewall_rules.purpose</code>. why are these ports opened?
	 */
	public final org.jooq.TableField<org.apache.cloudstack.db.jooq.generated.tables.records.FirewallRulesRecord, java.lang.String> PURPOSE = createField("purpose", org.jooq.impl.SQLDataType.CHAR.length(32).nullable(false), this);
	 ...
	 */
	public final org.jooq.TableField<org.apache.cloudstack.db.jooq.generated.tables.records.FirewallRulesRecord, java.lang.String> XID = createField("xid", org.jooq.impl.SQLDataType.CHAR.length(40).nullable(false), this);
	 ...
	 */
	public final org.jooq.TableField<org.apache.cloudstack.db.jooq.generated.tables.records.FirewallRulesRecord, java.lang.String> TRAFFIC_TYPE = createField("traffic_type", org.jooq.impl.SQLDataType.CHAR.length(32), this);
