...
public class NetworkOfferingsRecord extends org.jooq.impl.UpdatableRecordImpl<org.apache.cloudstack.db.jooq.generated.tables.records.NetworkOfferingsRecord> {
	...
	private static final long serialVersionUID = 477557883;

	/**
	 * Setter for <code>cloud.network_offerings.id</code>. id
	 */
	...
	/**
	 * Getter for <code>cloud.network_offerings.id</code>. id
	 */
	...
	/**
	 * Setter for <code>cloud.network_offerings.name</code>. name of the network offering
	 */
	...
	/**
	 * Getter for <code>cloud.network_offerings.name</code>. name of the network offering
	 */
	...
	/**
	 * Setter for <code>cloud.network_offerings.unique_name</code>. unique name of the network offering
	 */
	...
	/**
	 * Getter for <code>cloud.network_offerings.unique_name</code>. unique name of the network offering
	 */
	...
	/**
	 * Setter for <code>cloud.network_offerings.display_text</code>. text to display to users
	 */
	...
	/**
	 * Getter for <code>cloud.network_offerings.display_text</code>. text to display to users
	 */
	...
	/**
	 * Setter for <code>cloud.network_offerings.nw_rate</code>. network rate throttle mbits/s
	 */
	...
	/**
	 * Getter for <code>cloud.network_offerings.nw_rate</code>. network rate throttle mbits/s
	 */
	...
	/**
	 * Setter for <code>cloud.network_offerings.mc_rate</code>. mcast rate throttle mbits/s
	 */
	...
	/**
	 * Getter for <code>cloud.network_offerings.mc_rate</code>. mcast rate throttle mbits/s
	 */
	...
	/**
	 * Setter for <code>cloud.network_offerings.traffic_type</code>. traffic type carried on this network
	 */
	...
	/**
	 * Getter for <code>cloud.network_offerings.traffic_type</code>. traffic type carried on this network
	 */
	...
	/**
	 * Setter for <code>cloud.network_offerings.tags</code>. tags supported by this offering
	 */
	...
	/**
	 * Getter for <code>cloud.network_offerings.tags</code>. tags supported by this offering
	 */
	...
	/**
	 * Setter for <code>cloud.network_offerings.system_only</code>. Is this network offering for system use only
	 */
	...
	/**
	 * Getter for <code>cloud.network_offerings.system_only</code>. Is this network offering for system use only
	 */
	...
	/**
	 * Setter for <code>cloud.network_offerings.specify_vlan</code>. Should the user specify vlan
	 */
	...
	/**
	 * Getter for <code>cloud.network_offerings.specify_vlan</code>. Should the user specify vlan
	 */
	...
	/**
	 * Setter for <code>cloud.network_offerings.service_offering_id</code>. service offering id that virtual router is tied to
	 */
	...
	/**
	 * Getter for <code>cloud.network_offerings.service_offering_id</code>. service offering id that virtual router is tied to
	 */
	...
	/**
	 * Setter for <code>cloud.network_offerings.conserve_mode</code>. Is this network offering is IP conserve mode enabled
	 */
	...
	/**
	 * Getter for <code>cloud.network_offerings.conserve_mode</code>. Is this network offering is IP conserve mode enabled
	 */
	...
	/**
	 * Setter for <code>cloud.network_offerings.created</code>. time the entry was created
	 */
	...
	/**
	 * Getter for <code>cloud.network_offerings.created</code>. time the entry was created
	 */
	...
	/**
	 * Setter for <code>cloud.network_offerings.removed</code>. time the entry was removed
	 */
	...
	/**
	 * Getter for <code>cloud.network_offerings.removed</code>. time the entry was removed
	 */
	...
	/**
	 * Setter for <code>cloud.network_offerings.default</code>. 1 if network offering is default
	 */
	...
	/**
	 * Getter for <code>cloud.network_offerings.default</code>. 1 if network offering is default
	 */
	...
	/**
	 * Setter for <code>cloud.network_offerings.availability</code>. availability of the network
	 */
	...
	/**
	 * Getter for <code>cloud.network_offerings.availability</code>. availability of the network
	 */
	...
	/**
	 * Setter for <code>cloud.network_offerings.dedicated_lb_service</code>. true if the network offering provides a dedicated load balancer for each network
	 */
	...
	/**
	 * Getter for <code>cloud.network_offerings.dedicated_lb_service</code>. true if the network offering provides a dedicated load balancer for each network
	 */
	...
	/**
	 * Setter for <code>cloud.network_offerings.shared_source_nat_service</code>. true if the network offering provides the shared source nat service
	 */
	...
	/**
	 * Getter for <code>cloud.network_offerings.shared_source_nat_service</code>. true if the network offering provides the shared source nat service
	 */
	...
	/**
	 * Setter for <code>cloud.network_offerings.sort_key</code>. sort key used for customising sort method
	 */
	...
	/**
	 * Getter for <code>cloud.network_offerings.sort_key</code>. sort key used for customising sort method
	 */
	...
	/**
	 * Setter for <code>cloud.network_offerings.redundant_router_service</code>. true if the network offering provides the redundant router service
	 */
	...
	/**
	 * Getter for <code>cloud.network_offerings.redundant_router_service</code>. true if the network offering provides the redundant router service
	 */
	...
	/**
	 * Setter for <code>cloud.network_offerings.state</code>. state of the network offering that has Disabled value by default
	 */
	...
	/**
	 * Getter for <code>cloud.network_offerings.state</code>. state of the network offering that has Disabled value by default
	 */
	...
	/**
	 * Setter for <code>cloud.network_offerings.guest_type</code>. type of guest network that can be shared or isolated
	 */
	...
	/**
	 * Getter for <code>cloud.network_offerings.guest_type</code>. type of guest network that can be shared or isolated
	 */
	...
	/**
	 * Setter for <code>cloud.network_offerings.elastic_ip_service</code>. true if the network offering provides elastic ip service
	 */
	...
	/**
	 * Getter for <code>cloud.network_offerings.elastic_ip_service</code>. true if the network offering provides elastic ip service
	 */
	...
	/**
	 * Setter for <code>cloud.network_offerings.eip_associate_public_ip</code>. true if public IP is associated with user VM creation by default when EIP service is enabled.
	 */
	...
	/**
	 * Getter for <code>cloud.network_offerings.eip_associate_public_ip</code>. true if public IP is associated with user VM creation by default when EIP service is enabled.
	 */
	...
	/**
	 * Setter for <code>cloud.network_offerings.elastic_lb_service</code>. true if the network offering provides elastic lb service
	 */
	...
	/**
	 * Getter for <code>cloud.network_offerings.elastic_lb_service</code>. true if the network offering provides elastic lb service
	 */
	...
	/**
	 * Setter for <code>cloud.network_offerings.specify_ip_ranges</code>. true if the network offering provides an ability to define ip ranges
	 */
	...
	/**
	 * Getter for <code>cloud.network_offerings.specify_ip_ranges</code>. true if the network offering provides an ability to define ip ranges
	 */
	...
	/**
	 * Setter for <code>cloud.network_offerings.inline</code>. Is this network offering LB provider is in inline mode
	 */
	...
	/**
	 * Getter for <code>cloud.network_offerings.inline</code>. Is this network offering LB provider is in inline mode
	 */
	...
	/**
	 * Setter for <code>cloud.network_offerings.is_persistent</code>. true if the network offering provides an ability to create persistent networks
	 */
	...
	/**
	 * Getter for <code>cloud.network_offerings.is_persistent</code>. true if the network offering provides an ability to create persistent networks
	 */
	...
	/**
	 * Setter for <code>cloud.network_offerings.internal_lb</code>. true if the network offering supports Internal lb service
	 */
	...
	/**
	 * Getter for <code>cloud.network_offerings.internal_lb</code>. true if the network offering supports Internal lb service
	 */
	...
	/**
	 * Setter for <code>cloud.network_offerings.public_lb</code>. true if the network offering supports Public lb service
	 */
	...
	/**
	 * Getter for <code>cloud.network_offerings.public_lb</code>. true if the network offering supports Public lb service
	 */
	 ...
	 */
	public void setEgressDefaultPolicy(java.lang.Byte value) {
		setValue(31, value);
	}
	...
	/**
	 * Setter for <code>cloud.network_offerings.concurrent_connections</code>. Load Balancer(haproxy) maximum number of concurrent connections(global max)
	 */
	...
	/**
	 * Getter for <code>cloud.network_offerings.concurrent_connections</code>. Load Balancer(haproxy) maximum number of concurrent connections(global max)
	 */
	...
	/**
	 * Setter for <code>cloud.network_offerings.keep_alive_enabled</code>. true if connection should be reset after requests.
	 */
	...
	/**
	 * Getter for <code>cloud.network_offerings.keep_alive_enabled</code>. true if connection should be reset after requests.
	 */
